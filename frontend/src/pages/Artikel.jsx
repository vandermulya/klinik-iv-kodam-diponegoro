    ...
    return (
        ...
        <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
            <div className="mt-10 lg:w-1/2">
                <h1 className='text-3xl text-center font-[700] text-headingColor md:text-5xl lg:text-4xl xl:text-5xl lg:text-left lg:max-w-[540px]'>Read the most interesting articles.</h1>
            ...
            <div className="hidden lg:block lg:w-1/2">
                <img className='w-full lg:ml-[50px]' src={headArtImg} alt="Header Artikel" />
            </div>
        </section>
