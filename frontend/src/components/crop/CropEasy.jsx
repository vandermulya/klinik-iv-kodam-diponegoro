    ...
    return (
        <div className="fixed z-[1000] inset-0 bg-black/50 flex justify-center p-5 overflow-auto">
            <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
                <h2 className="font-semibold text-headingColor mb-4 text-center text-base">
                    Sesuaikan Gambar
                </h2>
                ...
                <button
                    ...
                    className="px-5 py-2.5 rounded-lg text-red-600 border border-red-600 text-sm disabled:opacity-70 hover:bg-red-600 hover:text-white font-medium"
                >
                    Batal
                </button>
                <button
                    ...
                    className="px-5 py-2.5 rounded-lg font-medium text-white bg-blue-600 text-sm disabled:opacity-70"
                >
                    Potong & Upload
                </button>
                </div>
