...
const registerUser = async (req, res, next) => {
    try {
        ...
        if (user) {
            throw new Error("Akun pengguna sudah terdaftar");
        }
...
const userProfile = async (req, res, next) => {
    try {
        ...
        if (user) {
            ...
            let error = new Error("Akun pengguna tidak ditemukan!");
...
const updateProfile = async (req, res, next) => {
    try {
        ...
        if (req.body.password && req.body.password.length < 6) {
            throw new Error("Panjang password harus lebih dari 6 karakter!");
